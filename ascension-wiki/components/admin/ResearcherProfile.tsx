                ...
                >
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex flex-col items-end gap-1">
                            ...
                            <span className="text-[9px] text-white/40 font-mono uppercase">Reputation: {reputation.toFixed(1)}</span>
                    ...
                    <div className="mt-8 flex gap-3">
                        <button aria-label="View Public Node Deployment" className="flex-1 py-2 px-4 rounded-lg bg-primary text-background text-[10px] font-bold uppercase tracking-widest hover:bg-white transition-all flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-primary">
                            <ExternalLink size={12} /> View Public Node
                        </button>
                        <button aria-label="Export Researcher Biography" className="flex-1 py-2 px-4 rounded-lg bg-white/5 border border-white/10 text-white/60 text-[10px] font-bold uppercase tracking-widest hover:bg-white/10 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20">
                            Export Bio
                        </button>
                    </div>
                </motion.div>
