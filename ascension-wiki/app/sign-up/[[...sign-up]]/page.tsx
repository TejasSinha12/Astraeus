    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-[600px] h-[600px] rounded-full bg-secondary/5 blur-[150px]" />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
                ...
                <div className="text-center mb-2">
                    ...
                    <h1 className="text-2xl font-semibold text-white">Request Research Access</h1>
                    <p className="text-muted text-sm mt-1">Create your account to join the framework</p>
                </div>
